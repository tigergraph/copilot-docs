...
After xref:partial$authentication.adoc[Authentication] there are xref:_user_guide[five ways] to interact with the TigerGraph CoPilot service:
...
As in this example script below:
+
[source, python]
----
...
----
+
. Then, you can get answers from the graph with the example script below:
+
[source, python]
----
...
+
The endpoints can be found on the Swagger documentation page.
