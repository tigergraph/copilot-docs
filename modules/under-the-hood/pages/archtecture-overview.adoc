...
* xref:tg-copilot:under-the-hood:supportai-overview.adoc[SupportAI] is a knowledge Q&A assistant for documents and graphs
* *(Not available in beta)* QueryAI is a GSQL code generator including query and schema generation, data mapping, and more.
