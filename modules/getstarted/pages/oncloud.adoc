...
CoPilot is available as an add-on service to your xref:cloud4:workgroup-workspace:workspaces/workspace.adoc[Workspace] on TigerGraph Cloud 4.0.

[IMPORTANT]
====
Contact beta-support@tigergraph.com to enable TigerGraph CoPilot as an option in the xref:cloud4:integrations:index.adoc[Marketplace].
